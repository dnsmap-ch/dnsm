...
class CnameParsingWwwMicrosoftChTest {
  ...
  private static final byte[] CNAME_BYTES_QUESTION = new byte[] {
      ...
      (byte) 0x63,
      (byte) 0x72, (byte) 0x6f, (byte) 0x73, (byte) 0x6f, (byte) 0x66, (byte) 0x74, (byte) 0x02,
      (byte) 0x63,
  ...
  private static final byte[] CNAME_BYTES_ANSWER = new byte[] {
      ...
      (byte) 0x00,
      (byte) 0x0e, (byte) 0x10, (byte) 0x00, (byte) 0x02, (byte) 0xc0, (byte) 0x10, (byte) 0xc0,
      (byte) 0x10,
      (byte) 0x00, (byte) 0x01, (byte) 0x00, (byte) 0x01, (byte) 0x00, (byte) 0x00, (byte) 0x0e,
      (byte) 0x10,
      (byte) 0x00, (byte) 0x04, (byte) 0x14, (byte) 0x67, (byte) 0x55, (byte) 0x21, (byte) 0xc0,
      (byte) 0x10,
      (byte) 0x00, (byte) 0x01, (byte) 0x00, (byte) 0x01, (byte) 0x00, (byte) 0x00, (byte) 0x0e,
      (byte) 0x10,
      (byte) 0x00, (byte) 0x04, (byte) 0x14, (byte) 0x70, (byte) 0x34, (byte) 0x1d, (byte) 0xc0,
      (byte) 0x10,
      (byte) 0x00, (byte) 0x01, (byte) 0x00, (byte) 0x01, (byte) 0x00, (byte) 0x00, (byte) 0x0e,
      (byte) 0x10,
      ...
      (byte) 0x00, (byte) 0x01, (byte) 0x00, (byte) 0x01, (byte) 0x00, (byte) 0x00, (byte) 0x0e,
      (byte) 0x10,
      (byte) 0x00, (byte) 0x04, (byte) 0x14, (byte) 0x51, (byte) 0x6f, (byte) 0x55, (byte) 0xc0,
      (byte) 0x10,
      (byte) 0x00, (byte) 0x01, (byte) 0x00, (byte) 0x01, (byte) 0x00, (byte) 0x00, (byte) 0x0e,
      (byte) 0x10,
  ...
  void testCnameInputParsing() throws IOException {
    ...
    assertThat(dnsInput.getAnswer().get(0)).satisfies(answer -> {
      ...
      assertThat(((ResourceRecordCname) answer).getCname().cname().getCanonical()).isEqualTo(
          DOMAIN_NAME);
    });
    assertThat(dnsInput.getAnswer().get(1)).satisfies(answer -> {
      ...
      assertThat(answer.getDnsClass()).isEqualTo(IN);
      assertThat(answer.getTtl()).isEqualTo(TTL);
      assertThat(((ResourceRecordA) answer).getIp4().getIp().getHostAddress()).isEqualTo(
          "20.103.85.33");
    });
